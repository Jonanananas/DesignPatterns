package com.flyweightborder;

public class Test {
   public static void main(String[] args) {
      String fly = "fly", weight = "weight";
      String fly2 = "fly", weight2 = "weight";
      System.out.println(fly == fly2); // fly and fly2 refer to the same String
      // instance
      ...
      System.out.println(flyweight == "flyweight"); // The intern() method returns
      // a flyweight
   }
}
